...
3. Make a copy of `nextflow.config` file, and make the following changes to the new version:
    ...
    b. In the `env` scope ensure:
        ...
        * FAST_INFILES points the iso-dated directory that has been made in the infiles directory which will contain the following files; raw_sequencing_batches.csv,readset_batches.csv and sequencing.csv e.g /home/bkutambe/data/seqbox/infiles/2022.09.22
